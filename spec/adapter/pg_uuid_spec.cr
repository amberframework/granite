...
class User < Granite::ORM::Base
  ...
  belongs_to :parent, foreign_key_type: String
  belongs_to :child, foreign_key_type: String
...
Parent.exec("CREATE EXTENSION IF NOT EXISTS pgcrypto;")
...
User.exec("CREATE EXTENSION IF NOT EXISTS pgcrypto;")
...
Child.exec("CREATE EXTENSION IF NOT EXISTS pgcrypto;")
